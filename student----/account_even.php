...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['6e447159425d2d']) && $_SESSION['6e447159425d2d'] == "6e447159425d2d" && isset($_GET['endquiz'])== 'end') 
{
  ...
  while ($row1 = mysqli_fetch_array($q1)) 
  {
        $s = $row1['score'];           
                ...
                header('location:https://apps.veltech.edu.in/exams/tesuto/student/account_even.php?q=1');
...
//print_r($ans);
            ...
            if ($_GET["t"] > $_GET["n"] && $_GET["n"] != 1) {
                ...
                echo '<br /><a href="account_even.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Save</font></button>&nbsp;&nbsp;&nbsp;&nbsp;';
                ...
                echo'&nbsp;&nbsp;&nbsp;&nbsp;<a href="account_even.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
