...
<link href='http://fonts.googleapis.com/css?family=Roboto:400,700,300' rel='stylesheet' type='text/css'>
  <script>
    ...
    document.addEventListener('keydown', function (e) {
        // Disable F12 key (Chrome, Edge, Safari, Opera)
         if ((e.key === 'F12' || e.keyCode === 123) || (e.ctrlKey && e.shiftKey && e.key === 'I')) {
            e.preventDefault();
        }
    });
</script>
...
<div class="row">
<div class="col-md-4">
  <span class="logo"><img src="logo-white.png" style="width: 38%; height: 20%;"></span>
   
  </div>
  <div class="col-md-4">
  <span class=""><p style="color:white; text-align: center;font-size:16px;"> <b>CENTRE FOR ACADEMIC RESEARCH<br> Admission to Ph.D. Degree Programmes<br> Entrance Examinations – Winter Semester 2023 – 24 </b></p> </span>
...
//    }
//    // if($eid==''){
//    //    header('location:http://localhost/coe_final%20/student/account_even.php?q=1');
//    // }
...
if (!(isset($_SESSION['student_username']))) {
   ...
   $even=$_SESSION["id"];
    ...
    include_once 'dbConnection.php';
    echo '<span class="pull-right top title1" ><span style="color:white"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span><span class="log log1" style="color:lightyellow">' . $name . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account_even.php" style="color:lightyellow"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}
  ...
  <div class="container-fluid">
   ...
   // {
    $q = mysqli_query($con, "SELECT * FROM tesuto_history WHERE username='$username'") or die('Error156');
            ...
            //   }
 if ($status == "ongoing" && isset($_SESSION["code"])){
                echo'<div style="float:right;"><font size="3" style="font-family:\'typo\' font-size:60px; font-weight:bold;color:darkred">Time Left : </font><font style="font-family:\'typo\';font-size:20px;font-weight:bold;color:darkblue;" id="countdown"></font><br></div>';
               }
...
if($_SESSION['6e447159fg']=='6e447159fg'){
 //echo "<script>alert('Dear Candidate,Your Online Examination is successfully completed');</script>";
  echo "<script>alert('DEAR CANDITATE,YOU HAVE SUCCESSFULLY COMPLETED THE ONLINE ENTRANCE EXAMINATION');</script>";
}
    echo '<div class="panel" id="exam_code_check"><table class="table table-striped title1 "  style="vertical-align:middle">
     <form action="account_even.php?q=1" method="post">
...
// <td style="vertical-align:middle"><b>Action</b></td></tr>';
    ...
    echo '<div class="panel"><table class="table table-striped title1"  style="vertical-align:middle">
<tr>';
echo' <td style="vertical-align:middle"><b>Candidate Name</b></td>
<td style="vertical-align:middle"><b>Department</b></td>
<td style="vertical-align:middle"><b>Total question</b></td>
<td style="vertical-align:middle"><b>Time limit</b></td>
<td style="vertical-align:middle"><b>Action</b></td>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($rowcount == 0) {
            ...
            echo '
            <td style="vertical-align:middle;font-size:14px;">' . $name . '</td>
            <td style="vertical-align:middle;font-size:14px;">' . $title . '</td>
            <td style="vertical-align:middle;font-size:14px;">' . $total . '</td>
            ...
            <td style="vertical-align:middle;display:none;">' . $correct * $total . '</td>
             <td style="vertical-align:middle;font-size:14px;">' . $time . '&nbsp;min</td>
  <td style="vertical-align:middle"><b><a href="account_even.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="color:#FFFFFF;background:darkgreen;font-size:12px;padding:7px;padding-left:10px;padding-right:10px"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span><b>Start</b></span></a></b></td></tr>';
...
$_SESSION['continue']='61454rff221';
                ...
                echo '
                <td style="vertical-align:middle;font-size:14px;">' . $name . '</td>
                <td style="vertical-align:middle;font-size:14px;">' . $title . '&nbsp;<span title="This exam is already solve by you" class="" aria-hidden="true"></span></td>
                <td style="vertical-align:middle;font-size:14px;">' . $total . '</td>
                <td style="vertical-align:middle;display:none;">+' . $correct . '</td>
                <td style="vertical-align:middle;display:none;">-' . $wrong . '</td>
                <td style="vertical-align:middle;display:none;">' . $correct * $total . '</td>
                <td style="vertical-align:middle;font-size:14px;">' . $time . '&nbsp;min</td>
  <td style="vertical-align:middle"><b><a href="account_even.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="margin:0px;background:darkorange;color:white">&nbsp;<span class="title1"><b>Continue</b></span></a></b></td></tr>';
            } else {
                //<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td>
              
                echo '<td style="vertical-align:middle;font-size:14px;">' . $name . '</td>
                <td style="vertical-align:middle;font-size:14px;">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $total . '</td>
    <td style="vertical-align:middle;display:none;">+' . $correct . '</td>
    <td style="vertical-align:middle;display:none;">-' . $wrong . '</td>
    <td style="vertical-align:middle;display:none;">' . $correct * $total . '</td>
                <td style="vertical-align:middle;font-size:14px;">' . $time . '&nbsp;min</td>
  <td style="vertical-align:middle"><b><a href="account_even.php?q=1" class="btn disabled" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>Exam Over</b></span></a></b></td></tr>';
            }
        }
    }
    $c = 0;
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['6e447159425d2d']) && $_SESSION['6e447159425d2d'] == "6e447159425d2d" && isset($_GET['endquiz'])== 'end') 
{
  ...
  while ($row1 = mysqli_fetch_array($q1)) 
  {
        $s = $row1['score'];           
                ...
                // veltech/exams/tesuto/
                header('location:http://localhost/veltech/exams/tesuto/account_even.php?q=1');
                // header('location:http://localhost/coe_final /student/account_even.php?q=1');
           // header('location:account_even.php?q=result&eid='.$_GET[eid]);
}
   ...
   // }
    ...
    if (mysqli_num_rows($q) > 0) {
        ...
        if ($status == "ongoing" && $remaining > 0 && $qstatus == "enabled") {
            ...
            header('location:account_even.php?q=quiz&step=2&eid=' . $_GET[eid] . '&n=' . $_GET[n] . '&t=' . $_GET[t]);
...
function end(){
 data = prompt("Do you want to END the Entrance Examination?.Type \"Yes\" and click \"OK\" button.Otherwise click \"Cancel\" button");
  if(data=="yes"||data=="YES"){
    window.location ="account_even.php?q=quiz&step=2&eid=' . $_GET["eid"] . '&n=' . $_GET["n"] . '&t=' . isset($_GET["total"]) . '&endquiz=end";
...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
 ...
 // echo '<font size="3" style="margin-left:900px;font-family:\'typo\' font-size:20px; font-weight:bold;color:darkred">Time Left : </font><span class="timer btn btn-default" style="margin-left:20px;"><font style="font-family:\'typo\';font-size:20px;font-weight:bold;color:darkblue;" id="countdown"></font></span><br>';
  ...
  // <font size="3" style="margin-left:900px;font-family:\'typo\' font-size:20px; font-weight:bold;color:darkred">Time Left : </font><span class="timer btn btn-default" style="margin-left:20px;"><font style="font-family:\'typo\';font-size:20px;font-weight:bold;color:darkblue;" id="countdown"></font></span><br> ';
            echo '<br><span class="timer btn btn-primary" style="margin-left:970px" onclick="end()"><span class=" glyphicon glyphicon-off"></span>&nbsp;&nbsp;<font style="font-size:12px;font-weight:bold">Finish Exam</font></span>';
            $eid   = @$_GET['eid'];
            $sn    = @$_GET['n'];
            $total = @$_GET['t'];
            //$branch 
...
//         echo '</tr><tr>';
//     }
 echo '<td><a class="'.$c.'" href="account_even.php?q=quiz&step=2&eid=' . $eid . '&n=' . $count . '&t='.$total.'" class="text-light" style="color:white;" role="button"><b>'.$count.'-</b><b>'.$show.'</b></a></td>';
   // echo ' <button  type="submit" class="' . $buttonClass . '"> 
   //  <a href="account_even.php?q=quiz&step=2&eid=' . $eid . '&n=' . $count . '&t='.$total.'" class="text-light" style="color:white;"><b>'.$count.'-</b><b>'.$show.'</b></a>
   //  </button>';
} 
...
exit();
            ...
            while ($row = mysqli_fetch_array($q)) {
                ...
                echo '<b><pre style="background-color:white"><div style="font-size:20px;font-weight:bold;font-family:calibri;margin:10px">' . $sn . ' : <img src="http://localhost/veltech/exams/tesuto/admin/uploads/' . $qns . '"> </div></pre></b>';
            }
...
//print_r($ans);
            ...
            if ($_GET["t"] > $_GET["n"] && $_GET["n"] != 1) {
                ...
                echo '<br /><a href="account_even.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px">Back</span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Save</font></button>&nbsp;&nbsp;&nbsp;&nbsp;';
            ...
            $q = mysqli_query($con, "SELECT * FROM tesuto_questions WHERE eid='$_GET[eid]'") or die("Error222");
            $i = 1;
            while ($row = mysqli_fetch_array($q)) {
                $ques[$row['qid']] = $i;
                $i++;
...
// }
    //  
            ...
            // for ($i = 1; $i <= $total; $i++) {
            //     echo '<a href="account_even.php?q=quiz&step=2&eid=' . $eid . '&n=' . $i . '&t=' . $total . '"  style="margin:5px;padding:5px;background-color:';
        ...
        $q = mysqli_query($con, "SELECT * FROM tesuto_history WHERE eid='$_GET[eid]' AND username='$_SESSION[student_username]'") or die('Error156');
            ...
            header('location:account_even.php?q=result&eid=' .$_GET[eid]);
           // header('http://localhost/coe_final%20/student/account_even.php?q=1');
    }
}
...
<center><h1 class="title" style="color:#660033">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
    ...
    <tr style="color:darkblue"><td style="vertical-align:middle">Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
        ...
        $q = mysqli_query($con, "SELECT * FROM tesuto_questions WHERE eid='$_GET[eid]'") or die('Error197');
        while ($row = mysqli_fetch_array($q)) {
            $question = $row['qns'];
            $qid      = $row['qid'];
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Quiz</b></td><td style="vertical-align:middle"><b>Total Questions</b></td><td style="vertical-align:middle"><b>Right</b></td><td style="vertical-align:middle"><b>Wrong<b></td><td style="vertical-align:middle"><b>Unattempted<b></td><td style="vertical-align:middle"><b>Score</b></td><td style="vertical-align:middle"><b>Action<b></td></tr>';
    ...
    while ($row = mysqli_fetch_array($q)) {
        ...
        $c++;
         // echo '<tr><td style="vertical-align:middle">' . $c . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $r . '</td><td style="vertical-align:middle">' . $w . '</td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td><td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle"><b><a href="account_even.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></td></tr>';
        echo '<tr><td style="vertical-align:middle">' . $c . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $r . '</td><td style="vertical-align:middle">' . $w . '</td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td><td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle"><b><a href="account_even.php?q=result&eid=" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result1</b></td></tr>';
    }
    echo '</table></div>';
}
if (@$_GET['q'] == 3) {
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    if($show == 1 && $total==1){
        ...
        $i = 1;
        while($i<=$total){
            echo '<td style="vertical-align:middle;text-align:center"><a style="font-size:14px;font-family:typo;font-weight:bold" href="account_even.php?q=3&show='.$i.'">&nbsp;'.$i.'&nbsp;</a></td>';
            $i++;
        }
        echo '<td style="vertical-align:middle;text-align:center"><a style="font-size:14px;font-family:typo;font-weight:bold" href="account_even.php?q=3&show='.($show+1).'">&nbsp;>>&nbsp;</a></td>';
    }
