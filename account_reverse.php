...
$_SESSION['continue']='61454rff221';
                ...
                <td style="vertical-align:middle;font-size:14px;">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="" aria-hidden="true"></span></td>
                <td style="vertical-align:middle;font-size:14px;">' . $total . '</td>
                <td style="vertical-align:middle;display:none;">+' . $correct . '</td>
                <td style="vertical-align:middle;display:none;">-' . $wrong . '</td>
                <td style="vertical-align:middle;display:none;">' . $correct * $total . '</td>
  ...
  <td style="vertical-align:middle"><b><a href="account_reverse.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="margin:0px;background:darkorange;color:white">&nbsp;<span class="title1"><b>Continue</b></span></a></b></td></tr>';
                ...
                //<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td>
                echo ' <td style="vertical-align:middle;font-size:14px;">' . $name . '</td>
                <td style="vertical-align:middle;font-size:14px;">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td>
                <td style="vertical-align:middle;font-size:14px;">' . $total . '</td>
    <td style="vertical-align:middle;display:none;">+' . $correct . '</td>
    <td style="vertical-align:middle;display:none;">-' . $wrong . '</td>
    <td style="vertical-align:middle;display:none;">' . $correct * $total . '</td>
  ...
  <td style="vertical-align:middle"><b><a href="account_reverse.php?q=1" class="btn disabled" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>Exam Over</b></span></a></b></td></tr>';
              echo' <div class="form-group" style=" text-align: center;font-style: normal;">
 <h3>Instructions: </h3>
        <h4>The results will be declared by 01.30. P.M (23.12.2023) and will be published on<br> institution website www.veltech.edu.in as well as in the notice boards of the Centre<br> for Academic Research in <br>
Block 29, Research Park, 3rd Floor. Room No:29308<br>

All eligible candidates shall report for Interview in the respective departments from<br> 2.30 P.M (23.12.2023) onwards.
</h4>
    </div>
';
            }
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['6e447159425d2d']) && $_SESSION['6e447159425d2d'] == "6e447159425d2d" && isset($_GET['endquiz'])== 'end') 
{
  ...
  while ($row1 = mysqli_fetch_array($q1)) 
  {
        $s = $row1['score'];           
                ...
                header('location:http://localhost/veltech/exams/tesuto/account_reverse.php?q=1');
...
//print_r($ans);
            ...
            if ($_GET["t"] > $_GET["n"] && $_GET["n"] != 1) {
                ...
                echo '<br /><a href="account_reverse.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px">Back</span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Save</font></button>&nbsp;&nbsp;&nbsp;&nbsp;';
