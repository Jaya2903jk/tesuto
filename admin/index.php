...
//    header('location:accountss.php?q=1');
// }
 if(isset($_SESSION['username']) && isset($_SESSION['key']) && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39'){
   header('location:admin/dashss.php?q=0');
}
else{}
?>
...
<div class="row">
<div class="col-lg-6">
<span class="logo"> Vel Tech Online Examination</span></div>
...
<div class="col-md-6">
<form role="form" method="post" autocomplete="off" action="adminss.php?q=index.php">
